  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden font-sans selection:bg-emerald-500 selection:text-black">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div className="absolute -top-[20%] -right-[10%] w-[70vw] h-[70vw] rounded-full bg-emerald-900/20 blur-[120px] mix-blend-screen opacity-60"></div>
        <div className="absolute -bottom-[20%] -left-[10%] w-[60vw] h-[60vw] rounded-full bg-emerald-600/10 blur-[150px] mix-blend-screen opacity-50"></div>
        <div className="absolute top-[40%] left-[20%] w-[30vw] h-[30vw] rounded-full bg-teal-800/20 blur-[100px] mix-blend-screen opacity-40"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 pt-24 pb-16 relative z-10 min-h-screen flex flex-col justify-center">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/20 line-clamp-1">
            <Zap className="w-6 h-6 text-black fill-current" />
          </div>
          <span className="text-2xl font-black tracking-tight text-white">
            Pag<span className="text-emerald-400">Recovery</span>
          </span>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center mt-12 lg:mt-0">
          ...
          <div className="flex flex-col space-y-8 order-2 lg:order-1">
            ...
            >
              <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6">
                ...
                <span className="text-sm font-medium text-emerald-300">Nova IA de Recuperação Ativa</span>
              </div>
              ...
              <h1 className="text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight mb-6 mt-2">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 via-emerald-400 to-teal-500">
                  Nós buscamos para você.
                </span>
              </h1>
              
              <p className="text-xl text-zinc-400 max-w-xl leading-relaxed font-light">
                Esqueça os Pix não pagos e carrinhos abandonados. O agente inteligente da PagRecovery trabalha 24/7 para converter suas vendas perdidas e turbinar seu faturamento.
              </p>
            </motion.div>
            ...
            >
              <button className="group relative px-8 py-4 bg-emerald-500 hover:bg-emerald-400 text-black font-bold rounded-2xl transition-all duration-300 hover:shadow-[0_0_40px_-10px_rgba(52,211,153,0.6)] hover:-translate-y-1 overflow-hidden">
              ...
              <button className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white font-medium rounded-2xl border border-white/10 transition-all duration-300 flex items-center justify-center space-x-2 backdrop-blur-sm">
            ...
            >
              <div className="flex flex-col space-y-1">
                ...
                <span className="text-sm text-zinc-500 font-medium">Recuperação Média</span>
              </div>
              <div className="flex flex-col space-y-1">
                <div className="flex items-center space-x-2 text-emerald-400">
                ...
                <span className="text-sm text-zinc-500 font-medium">Automação Ininterrupta</span>
              </div>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="relative w-full h-[500px] lg:h-[700px] max-w-2xl mx-auto flex items-center justify-center">
              ...
              <Image 
                src="/mascot.png" 
                alt="PagRecovery Agent Character"
                fill
                priority
                className="object-contain object-center drop-shadow-[0_0_50px_rgba(52,211,153,0.3)] filter contrast-[1.05]"
              />
              ...
              >
                <div className="flex items-center space-x-3">
                  <div className="bg-emerald-500 p-2 rounded-lg shadow-[0_0_15px_rgba(52,211,153,0.5)]">
                    <TrendingUp className="w-6 h-6 text-black" />
                  </div>
                  <div>
                    <p className="text-xs text-zinc-400 font-medium tracking-wide border-b-transparent uppercase line-clamp-1">Conversão Hoje</p>
