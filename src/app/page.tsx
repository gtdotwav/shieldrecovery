...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(249,115,22,0.12),transparent_24rem),radial-gradient(circle_at_top_right,rgba(15,23,42,0.06),transparent_28rem),linear-gradient(180deg,#fbfbfc_0%,#f3f5f8_50%,#eef1f5_100%)]">
      <main className="mx-auto max-w-[88rem] px-4 pb-24 pt-6 sm:px-6 sm:pt-8 lg:px-8">
        <section className="relative overflow-hidden rounded-[2rem] border border-black/[0.06] bg-[linear-gradient(135deg,#11131a_0%,#171a24_45%,#1a1f2d_100%)] px-5 py-6 shadow-[0_35px_80px_rgba(15,23,42,0.16)] sm:px-8 sm:py-8 lg:px-10 lg:py-10">
          <div className="absolute inset-y-0 right-0 w-[32rem] bg-[radial-gradient(circle_at_top_right,rgba(249,115,22,0.22),transparent_42%)]" />
          <div className="absolute -left-12 top-24 h-40 w-40 rounded-full bg-[rgba(249,115,22,0.08)] blur-3xl" />
            ...
            <div className="mt-10 grid gap-8 xl:grid-cols-[minmax(0,1.15fr)_26rem] xl:items-start">
              <div className="max-w-4xl">
                ...
                <p className="mt-5 max-w-2xl text-lg leading-8 text-white/72">
                  Shield Recovery organiza a carteira, inicia o follow-up e mantém CRM,
              ...
              <PlatformSurface className="border-white/8 bg-white/7 p-5 shadow-none backdrop-blur-xl">
                <div className="flex items-center justify-between border-b border-white/8 pb-4">
                  <div>
                    <p className="text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-orange-300">
                      Fluxo do produto
                    </p>
                  ...
                  {ecosystem.map((item, index) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <span className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/8 text-[0.68rem] font-semibold text-orange-300">
                          {index + 1}
                        </span>
          ...
          <PlatformSurface className="p-5 sm:p-6">
            <div className="grid gap-3 sm:grid-cols-2">
              {modules.map((module) => (
                ...
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-[0.95rem] bg-[rgba(249,115,22,0.1)]">
  ...
  return (
    <div className="rounded-[1.2rem] border border-white/10 bg-white/7 px-4 py-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]">
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex h-10 w-10 items-center justify-center rounded-full bg-orange-500/14 ring-1 ring-orange-400/18">
