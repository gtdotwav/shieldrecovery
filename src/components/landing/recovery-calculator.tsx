    ...
    <section className="relative z-10 mx-auto max-w-[82rem] px-4 py-20 sm:px-8 sm:py-28 lg:px-10">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-lg text-sm leading-6 text-gray-400 sm:mt-4 sm:text-[0.95rem] sm:leading-7">
          ...
          recuperável com a {b.name}.
        </p>
      </div>

      <div className="mx-auto mt-10 max-w-[62rem] sm:mt-14">
        <div
          className="overflow-hidden rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] backdrop-blur-xl sm:rounded-2xl sm:shadow-[0_32px_80px_rgba(0,0,0,0.4)]"
          style={{
        ...
        >
          <div className="grid md:grid-cols-[1.1fr_1fr]">
            {/* ─── Inputs ─── */}
            <div
              className="border-b p-5 sm:p-8 md:border-b-0 md:border-r"
              style={{ borderColor: `rgba(${rgb},0.06)` }}
            >
              <div className="flex items-center gap-2.5">
                ...
                >
                  <Calculator className="h-4 w-4" style={{ color: `rgba(${rgb},0.6)` }} />
                </div>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {PRESETS.map((preset) => (
                  <button
                    ...
                    className="rounded-md border border-white/[0.06] bg-white/[0.02] px-3 py-1.5 text-xs font-medium text-gray-500 transition-colors hover:border-white/[0.12] hover:bg-white/[0.04] hover:text-gray-300"
                  >
                    {preset.label}
                  </button>
                ))}
              ...
              <div className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-2.5 h-1.5 w-full cursor-pointer appearance-none rounded-full bg-white/[0.06] accent-[var(--accent)] [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-[var(--accent)] [&::-webkit-slider-thumb]:bg-[var(--accent)] [&::-webkit-slider-thumb]:shadow-[0_2px_8px_var(--accent-glow)]"
                  />
              ...
              <p className="mt-6 text-xs leading-4 text-gray-600">
                * Projeção baseada em taxa de recuperação de {(RECOVERY_RATE * 100).toFixed(0)}%,
                média observada em operações ativas da {b.name}.
              </p>
            </div>
            ...
            <div className="relative flex flex-col justify-center p-5 sm:p-8">
              ...
              <div
                ...
                style={{ background: `radial-gradient(ellipse at center, rgba(${rgb},0.04), transparent 70%)` }}
              />
              ...
              <div className="relative space-y-5 sm:space-y-6">
                <div>
                  ...
                  <p className="mt-1.5 text-xl font-bold tracking-tight text-[#ff7a74]/80 sm:text-[1.85rem]">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.08em]" style={{ color: `rgba(${rgb},0.5)` }}>
                    Recuperação mensal projetada
                  </p>
                  <p className="mt-1.5 text-2xl font-bold tracking-tight sm:text-[2.4rem]" style={{ color: b.accent }}>
                ...
                >
                  <div className="flex items-center gap-2">
                    <TrendingUp className="h-4 w-4" style={{ color: `rgba(${rgb},0.5)` }} />
                    <p className="text-xs font-medium uppercase tracking-[0.08em]" style={{ color: `rgba(${rgb},0.5)` }}>
                      Projeção anual
                    </p>
                  </div>
                  <p className="mt-2 text-2xl font-bold tracking-tight text-white sm:text-[2.6rem]">
                ...
                <Link
                  href="/quiz"
                  className="group mt-2 inline-flex w-full items-center justify-center gap-2.5 rounded-xl px-6 py-3.5 text-sm font-semibold text-white transition-all hover:brightness-110"
                  style={{
                    background: b.accent,
    ...
    <div>
      ...
      <div className="relative mt-1.5">
        ...
        <input
          ...
          onChange={onChange}
          placeholder="0,00"
          className="w-full rounded-lg border border-white/[0.06] bg-white/[0.03] py-2.5 pl-10 pr-4 text-sm font-semibold tabular-nums text-gray-200 outline-none transition-colors placeholder:text-gray-600 focus:border-[var(--accent)]/25 focus:ring-1 focus:ring-[var(--accent)]/8"
        />
      </div>
