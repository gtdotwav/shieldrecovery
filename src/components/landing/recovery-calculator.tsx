  ...
  return (
    <section className="relative z-10 mx-auto max-w-[82rem] px-4 py-16 sm:px-8 sm:py-24 lg:px-10">
      <div className="text-center">
        <p className="font-mono text-[0.65rem] font-semibold uppercase tracking-[0.2em] text-[var(--accent)]/70 sm:tracking-[0.3em]">
          Simulador
        </p>
      ...
      <div className="mx-auto mt-10 max-w-[62rem] sm:mt-14">
        <div className="overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-[rgba(10,10,10,0.5)] shadow-[0_20px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl sm:rounded-2xl sm:shadow-[0_32px_80px_rgba(0,0,0,0.3)]">
          <div className="grid md:grid-cols-[1.1fr_1fr]">
            {/* ─── Inputs ─── */}
            <div className="border-b border-gray-100 dark:border-gray-800 p-5 sm:p-8 md:border-b-0 md:border-r">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {PRESETS.map((preset) => (
                  <button
                    ...
                    className="rounded-md border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-white/[0.02] px-3 py-1.5 text-xs font-medium text-gray-400 dark:text-gray-500 transition-colors hover:border-[var(--accent)]/15 hover:bg-[var(--accent)]/[0.04] hover:text-gray-600 dark:hover:text-gray-300"
                  >
                    {preset.label}
                  </button>
                ))}
              ...
              <div className="mt-6 space-y-5">
                ...
                <div>
                  ...
                  />
                  <div className="mt-1.5 flex justify-between text-xs text-gray-300 dark:text-gray-600">
                    <span>1%</span>
              ...
              <p className="mt-6 text-xs leading-4 text-gray-300 dark:text-gray-600">
            ...
            <div className="relative flex flex-col justify-center p-5 sm:p-8">
              ...
              <div className="relative space-y-5 sm:space-y-6">
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.08em] text-gray-400 dark:text-gray-600">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-[0.08em] text-[var(--accent)]/50">
                    Recuperação mensal projetada
                  </p>
                  <p className="mt-1.5 text-2xl font-bold tracking-tight text-[var(--accent)] sm:text-[2.4rem]">
                ...
                <div className="rounded-xl border border-[var(--accent)]/8 bg-[var(--accent)]/[0.03] px-4 py-3 sm:px-5 sm:py-4">
                  ...
                  <p className="mt-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-[2.6rem]">
  ...
  return (
    <div>
      ...
      <div className="relative mt-1.5">
        <span className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 text-sm font-semibold text-gray-400 dark:text-gray-500">
          {prefix}
        </span>
        <input
          type="text"
          ...
          onChange={onChange}
          placeholder="0,00"
          className="w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-white/[0.03] py-2.5 pl-10 pr-4 text-sm font-semibold tabular-nums text-gray-700 dark:text-gray-200 outline-none transition-colors placeholder:text-gray-300 dark:placeholder:text-gray-600 focus:border-[var(--accent)]/25 focus:ring-1 focus:ring-[var(--accent)]/8"
        />
      </div>
      <p className="mt-1 text-xs text-gray-300 dark:text-gray-600">{hint}</p>
    </div>
  );
}
