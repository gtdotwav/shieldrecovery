export type RecoveryLeadStatus = "NEW_RECOVERY" | "CONTACTING" | "WAITING_CUSTOMER" | "RECOVERED" | "LOST" | "EXPIRED";
...
export type CallStatus = "queued" | "ringing" | "in_progress" | "completed" | "failed" | "no_answer" | "busy" | "voicemail" | "cancelled";
export type CallOutcome = "recovered" | "callback_scheduled" | "interested" | "no_interest" | "wrong_number" | "voicemail_left" | "no_voicemail" | "technical_issue" | "other";
export type Lead = {
    id: string;
    leadId: string;
    paymentId: string;
